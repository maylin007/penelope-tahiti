              ...
              <AnimatedSection>
                <div className="space-y-10">
                  ...
                  <div className="border-t border-divider pt-10 space-y-3">
                    <a href="tel:+68940429387" className="group flex items-center gap-4 py-3 transition-colors duration-300">
                      ...
                      <div>
                        <p className="text-[10px] tracking-[0.2em] uppercase text-muted">Telephone</p>
                        <p className="text-dark text-[15px] group-hover:text-brand transition-colors">40 42 93 87</p>
                      </div>
                    </a>
