      ...
      <section className="pt-32 pb-20 px-6 bg-light">
        <div className="max-w-7xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-muted text-base max-w-xl mx-auto font-light">{t(T.subtitle, lang)}</p>
          </AnimatedSection>
        </div>
      </section>
            ...
            <div>
              <AnimatedSection>
                <div className="space-y-10">
                  <div>
                    <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4">{t(T.phoneLabel, lang)}</p>
                  ...
                  <div className="border-t border-divider pt-10">
                    <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4">{t(T.emailLabel, lang)}</p>
                  ...
                  <div className="border-t border-divider pt-10">
                    <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4">{t(T.addressLabel, lang)}</p>
                    <p className="text-dark text-[15px]">Rue Lagarde</p>
                    <p className="text-dark text-[15px]">{t(T.addressCity, lang)}</p>
                    <p className="text-muted text-sm mt-2">{t(T.addressNote, lang)}</p>
                  </div>

                  <div className="border-t border-divider pt-10">
                    <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-6">{t(T.hoursLabel, lang)}</p>
                    <HoursTable />
                  </div>
                  ...
                  <div className="border-t border-divider pt-10 space-y-3">
                    <a href="https://m.me/penelopetahitiboutique" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 py-3 transition-colors duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-dark text-[15px] group-hover:text-brand transition-colors">{t(T.messenger, lang)}</p>
                      </div>
                    </a>
                    <a href="https://www.facebook.com/penelopetahitiboutique/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 py-3 transition-colors duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-dark text-[15px] group-hover:text-brand transition-colors">{t(T.facebook, lang)}</p>
                      </div>
                    </a>
                  </div>
                </div>
            ...
            <AnimatedSection delay={0.2}>
              <div className="aspect-square lg:aspect-auto lg:h-full min-h-[500px] overflow-hidden">
                <iframe
                  ...
                  title="Boutique Penelope — Papeete"
                />
              </div>
            </AnimatedSection>
          </div>
